      ...
      <scroll class="shortcut" ref="scroll">
        <div>
          <div class="hot-key">
            ...
            <ul><li class="item" v-for="item in hotKey" :key="item.n" @click="addQuery(item.k)">{{ item.k }}</li></ul>
          </div>
...
<!--            <search-history-list :history="searchHistory" @deleteOne="$_deleteOne" @select="$_addQuery" />-->
    ...
    <div class="search-result" ref="searchResult" v-show="query">
      <search-list ref="searchList" :query="query" />
    </div>
    <confirm ref="confirm" text="是否清空所有搜索记录" confirmBtnText="清空"></confirm>
